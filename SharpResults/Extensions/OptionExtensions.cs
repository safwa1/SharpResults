...
public static class OptionExtensions
{
    ...
    {
        ThrowIfNull(mapper);
        return self.WhenSome(out var value) ? mapper(value) : defaultValue;
    }
    ...
    public static T UnwrapOr<T>(this Option<T> self, T defaultValue)
        where T : notnull
    {
        return self.WhenSome(out var value) ? value : defaultValue;
    }
        ...
        where T : notnull
    {
        ...
        return self.WhenSome(out var value) ? value : defaultFactory();
    }
    ...
    public static Option<T> Flatten<T>(this Option<Option<T>> self)
        where T : notnull
    {
        return self.WhenSome(out var nested) ? nested : default;
    }
        ...
        where T : notnull
    {
        ...
        return self.WhenSome(out var value) && predicate(value) ? self : default;
    }
    ...
    public static Option<(T1, T2)> Zip<T1, T2>(this Option<T1> self, Option<T2> other)
        ...
        where T2 : notnull
    {
        return self.WhenSome(out var x) && other.WhenSome(out var y)
    ...
    {
        ThrowIfNull(thenFn);
        return self.WhenSome(out var value) ? thenFn(value) : default;
    }
    ...
    public static bool IsNoneOr<T>(this Option<T> optional, Func<T, bool> f) where T : notnull
    {
        return optional.IsNone || f(optional.Unwrap());
    }
